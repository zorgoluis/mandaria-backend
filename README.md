# Mandaria — V1.12-C B2B Webhook Delivery
...
- `b2b-webhooks/`: V1.12-C transporte del evento: configuración del destino, política SSRF de la URL, el intento HTTP con timeout y su historial append-only.
