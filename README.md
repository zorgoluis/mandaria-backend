# Mandaria — V1.12-D Reliable & Secure B2B Webhook Delivery
...
- `b2b-webhooks/`: V1.12-C/D transporte del evento: configuración del destino, política SSRF de la URL, el intento HTTP con timeout y su historial append-only, y V1.12-D el worker con lease, la política de reintentos y la firma HMAC con su secreto cifrado.
